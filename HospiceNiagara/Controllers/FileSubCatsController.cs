...
namespace HospiceNiagara.Controllers
{
    public class FileSubCatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FileSubCatName")] FileSubCat fileSubCat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FileSubCatName")] FileSubCat fileSubCat)
        {
            if (ModelState.IsValid)
            {
