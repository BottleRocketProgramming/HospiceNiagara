        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string[] selectedRoles) //, ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    m.Body = String.Format("Dear " + user.UserFullName + ", <br/><br/> You have been registered as a volunteer in the brand new Hospice Niagara Portal at ‘www.hospiceniagaraportal.ca’. The Portal puts all HN related announcements, schedules, contacts, resources, and meetings and events at your fingertips, all while filtering the content so you only get the information that’s relevant to you.<br /><br />The portal is designed from the ground up to be easy to navigate, and in line with this thinking a fully annotated video walkthrough has been created that fully outlines how to use the Portal which you can view by clicking <a href='https://www.youtube.com/watch?v=iud4Zzd36H8'>Here</a>.<br/><br/> With this information in hand please feel free to explore the site! We are actively taking feedback to ensure that the site is as intuitive and easy to use as possible, so please do not hesitate to send your feedback via email to ‘programmer@hospiceniagara.ca’.<br/><br />Once you have been navigated to the portal login page, please log in with your email and the password ‘<b>Volunteer1</b>’. You will be asked to change this password after login.<br/><br/> <a href=\"{1}\" title= \"User Email Confirmation\">Click this link to confirm your e-mail</a><br /><br />Thank you for registering and we hope to hear your feedback!", user.UserName, Url.Action("ConfirmEmail", "Account", new { Token = user.Id, Email = user.Email }, Request.Url.Scheme));
                    m.IsBodyHtml = true;
